...
* @author Timothy 'TiM' Oliver Modify by Rolando Arriaza <rolignu90@gmail.com>
...
class SQLite3Database
{
	...
	*/
	function __construct( $db_file = '', $prefix = '', $connect = true )
	{
                ...
                //Config the sqlite file
                $validacion = new SivarApi\Tools\Validation();
                if($validacion->Is_Empty_OrNull($db_file))
                {
                    include "/Conf/Config.php"; 
                    $db_file = $CONFIG_["DB_SQLITE"]["dir"];
                }
